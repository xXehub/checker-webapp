    ...
    <div class="container-xl">
        ...
        <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
            <a href="{{ route('dashboard') }}">
                <img src="{{ asset('img/logo.svg') }}" width="110" height="32" alt="Bank Checker" class="navbar-brand-image">
            </a>
        </h1>
        {{-- <div style="color:white; padding:10px;">
            Current route: {{ Route::currentRouteName() }}
            Dashboard active: {{ Route::is('dashboard') ? 'Yes' : 'No' }}
            Banks active: {{ Route::is('banks.*') ? 'Yes' : 'No' }}
        </div> --}}
        {{-- iki gawe lek gorong login --}}
                            ...
                            <div class="list-group list-group-flush list-group-hoverable">
                                <div class="list-group-item">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col text-truncate">
                                            <a href="#" class="text-body d-block">Notifikasi 1</a>
                                            <div class="d-block text-muted text-truncate mt-n1">
                                                Detail notifikasi pertama
                                            </div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="list-group-item">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col text-truncate">
                                            <a href="#" class="text-body d-block">Notifikasi 2</a>
                                            <div class="d-block text-muted text-truncate mt-n1">
                                                Detail notifikasi kedua
                                            </div>
                                        </div>
                                        <div class="col-auto">
        ...
        <div class="collapse navbar-collapse" id="navbar-menu">
            <div class="d-flex flex-column flex-md-row flex-fill align-items-stretch align-items-md-center">
                <ul class="navbar-nav">
                    <li class="nav-item {{ Route::is('dashboard') || Route::is('home') ? 'active' : '' }}">
