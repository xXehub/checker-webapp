                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @if (isset($result))
                                @if ($result['success'])
                                    <!-- Jika data ditemukan, tampilkan accordion -->
                                    <div class="accordion mt-4" id="accordion-result">
                                        <div class="accordion-item">
                                            <h2 class="accordion-header" id="heading-result">
                                                <button class="accordion-button" type="button"
                                                    data-bs-toggle="collapse" data-bs-target="#collapse-result"
                                                    aria-expanded="true" aria-controls="collapse-result">
                                                    Detail Hasil Pengecekan
                                                </button>
                                            </h2>
                                            <div id="collapse-result" class="accordion-collapse collapse show"
                                                aria-labelledby="heading-result" data-bs-parent="#accordion-result">
                                ...
                                @else
                                    <!-- Jika data tidak ditemukan, tampilkan alert not found -->
